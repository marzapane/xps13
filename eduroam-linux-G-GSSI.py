...
Config.instname = "GSSI - Gran Sasso Science Institute"
Config.profilename = "GSSI"
Config.url = "https://www.gssi.it/"
Config.email = "ict@gssi.it"
Config.title = "eduroam CAT"
Config.server_match = "radserv.gssi.it"
...
Config.user_realm = "gssi.it"
Config.ssids = ['eduroam', 'GSSI']
Config.del_ssids = []
Config.servers = ['DNS:radserv.gssi.it']
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymous@gssi.it"
Config.verify_user_realm_input = True
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
"""
run_installer()
